...
@section('page-script')
    ...
    <script type="module">
        let selections = [];
        let routes = {'delete-diagnoses': '{{ route('guides-removeMedicament') }}'};
        ...
        function initTable() {
            $table.bootstrapTable({
                columns: [
                    {field: 'name', title: 'Препарат', align: 'center', sortable: !0},
    ...
    <div class="modal fade" id="updateGuide">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <form class="ajax-post-form" method="POST" action="{{ route('guides-editMedicament') }}">
                    <div class="modal-body">
                        <input type="hidden" name="id" id="diagnoses_id">
                        <div class="mb-2">
                            <label class="form-label" for="name">Препарат</label>
                            <input name="name" id="name" type="text" class="form-control form-control-sm" placeholder="Препарат" required>
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h4 class="card-title m-0">Справочник - препараты</h4>
                </div>
                <div class="card-body">
                    <div id="toolbar">
                    ...
                    <table id="bootstrap_tbl"
                           ...
                           data-url="{{ route('guides-getMedicaments') }}">
                    </table>
                </div>
            </div>
        </div>
